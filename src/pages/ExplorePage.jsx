				...
				<Container className="py-8 md:py-12">
					<div className="flex flex-col lg:flex-row gap-8">
						...
						<div className="flex-1 min-w-0">
							...
							{/* ── Page Header ── */}
							<div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4  border-b border-gray-100 mb-8 mt-5">
								<div>
						...
						<aside className="w-full lg:w-[320px] shrink-0 flex flex-col gap-6 lg:pl-8 lg:border-l lg:border-gray-100">
							...
							{/* Get Started CTA */}
							<div className="bg-blue-600 rounded-2xl p-5 relative overflow-hidden min-h-[160px] mt-5">
